            ...
            <Draggable :key="card.id" v-for="card in column.children">
              <div :class="card.props.className" :style="card.props.style">
                <div class="row justify-between">
                  <p class="text-bold">Feedback card</p>
                </div>
                <p>{{ card.data }}</p>
                <div class="row items-center justify-end">
                  <div>+2</div>
                  <q-btn flat round icon="thumb_up" color="primary"></q-btn>
                </div>
              </div>
            </Draggable>
          </Container>
...
Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`;
  ...
  const columnNames = [ "Under Consideration", "Research & Design", "Development", "Launched" ];
